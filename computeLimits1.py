...
SETENV = 'cd /uscms_data/d2/aris/CMSSW_6_1_2/src/limits; eval `scram runtime -csh`;'
...
if __name__ == '__main__':
    ...
    workdir = '/uscms_data/d2/aris/CMSSW_6_1_2/src/limits/tmp/' + pointName
...
#        sys.exit(0)
    ...
    with open('./xsec/' + model + '.xsecs') as xsecsource:
